...
export default function CoverLetterPage(): ReactElement {
  return (
    <div className="container mx-auto py-8 px-4 space-y-8">
      ...
      {/* Features Section */}
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        <Card className="p-6 md:col-span-2 border-primary/10 shadow-md">
          <CoverLetterForm />
        </Card>

        <div className="space-y-6">
          <Card className="p-6 bg-primary/5 border-primary/10 shadow-md">
          ...
          <Card className="p-6 bg-muted/50 border-muted shadow-md">
